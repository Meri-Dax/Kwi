...
impl From<(&uuid::Uuid, &RecipeRecipeLogisticsWebForm)> for RecipeRecipeLogisticsForm {
    fn from((recipe_id, recipe_logistics): (&uuid::Uuid, &RecipeRecipeLogisticsWebForm)) -> Self {
        Self {
            recipe_id: *recipe_id,
            recipe_logistics_id: recipe_logistics.id,
        }
