...
pub const BAD_REQUEST: HttpResponseMessage = http_response_message!("Bad Request", 400);
pub const UNAUTHORIZED: HttpResponseMessage = http_response_message!("Unauthorized", 401);
pub const FORBIDDEN: HttpResponseMessage = http_response_message!("Forbidden", 403);
pub const NOT_FOUND: HttpResponseMessage = http_response_message!("Not Found", 404);
pub const INTERNAL_SERVER_ERROR: HttpResponseMessage = http_response_message!("Internal Server Error", 500);
